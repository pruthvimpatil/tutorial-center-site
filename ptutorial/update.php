...
<div class="head1">
  ...
  <div class="dropdown">
    ...
    <div class="abc">
           ...
           <h1 style="text-align:center;">UPDATE A COURSE</h1>
           <br>
           <p>
           <lable>Enter course id of the course that should be upadted:</lable>
           ...
           <p>
           <lable>Enter course upadted name:</lable>
           <input type="text" name="name" style="width:500px" required>
           </p>
           <p>
           <lable>Enter course updated price:</lable>
